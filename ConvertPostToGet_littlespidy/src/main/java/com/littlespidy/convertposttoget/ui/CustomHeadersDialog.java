 ...
 * and API keys to inject into attack requests.
 *
 * @author littlespidy
 */
public class CustomHeadersDialog extends JDialog {
    ...
    public CustomHeadersDialog(Frame owner, List<ConfiguredHeader> existingHeaders, Consumer<List<ConfiguredHeader>> saveCallback) {
        ...
        JLabel descLabel = new JLabel("<html>Enter one header per line in <code>Header-Name: value</code> format. These headers will be automatically applied to both baseline requests and converted GET requests.</html>");
