...
| **Session Inspector** | [📥 `session-inspector-littlespidy-1.0.0.jar`](file:///home/littlespidy/myextra/burpsuite/SessionInspector_littlespidy/build/libs/session-inspector-littlespidy-1.0.0.jar) | Automated session timeout and token expiration tester with staged milestone timers, systematic credential finder, Cookie Store with one-click value copying & repetition counting, and cookiesearch.org cookie explainer |
